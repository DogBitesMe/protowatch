...
//.idata:3CE9D69C ; public: __thiscall std::basic_string<char, struct std::char_traits<char>, class std::allocator<char>>::~basic_string<char, struct std::char_traits<char>, class std::allocator<char>>(void)
	...
	REBASE(bnetlib, D3__std__String_delete, 0x3CE9D698, 0x3C910000) 

	// may shield colitions
	// 64 A3 00 00 00 00  8B 45 0C 50 8B 4D 08 51 8d 4d E8 E8 3B ED FF FF  89 45 E4 8B 55 E4 89 55
	REBASE(bnetlib, D3__TextFormat__PrintToString, 0x3CB748B0, 0x3C910000)

	// 55 8B EC 83 EC 0C 89 4D  F4 8D 45 F8 50 8B 4D F4 8B 11 8B 4D F4 8B 42 48  FF D0 8B 00 8B E5 5D C3
	REBASE(bnetlib, D3__Message__GetDescriptor, 0x3CB74F30,    0x3C910000)
	
	// 55 8B EC 51 89 4D FC 8B  45 FC 8B 40 04 8B E5 5D C3
	REBASE(bnetlib, D3__Descriptor__full_name, 0x3CB75330, 0x3C910000) 
	
	//55 8B EC 8B 45 0C 8B 10 8B 4D 0C 8B 42 0C FF D0 8B 4D 0C 51 8B 55 08 52 E8 ? ? ? ? 83 C4 08
	REBASE(bnetlib, deserialize_message, 0x3CB90D60, 0x3C910000)

	REBASE(bnetlib, bnet_protobuf_parse, 0x3CB902C0, 0x3C910000)
...
//.text:3CD5F6E3                 test    al, al
	...
	REBASE(bnetlib, recvmessage_entry, 0x3CD5F6D8, 0x3C910000)
	REBASE(bnetlib, recvmessage_return, 0x3CD5F6E3, 0x3C910000)
...
//8B 4E 70 85 C9 74 0B 8B  11 8B 42 10 FF D0 84 C0
	REBASE(bnetlib, recvmessage1_entry, 0x3CD5F199, 0x3C910000)
	REBASE(bnetlib, recvmessage1_return, 0x3CD5F1A0, 0x3C910000)
...
//.text:3CD70774                 call    edx
	...
	REBASE(bnetlib, recvheader_entry, 0x3CD7076D, 0x3C910000)
	REBASE(bnetlib, recvheader_return, 0x3CD70774, 0x3C910000)
...
//.text:3CD70845                 pop     edi
	...
	REBASE(bnetlib, sendheader_entry, 0x3CD7083E, 0x3C910000)
	REBASE(bnetlib, sendheader_return, 0x3CD70845, 0x3C910000)
...
// 8B 10 8B 52 28 8D 0C 3B 51 8B C8 FF D2 8B 45 08 50 8D ? ? C7 46 60 01 00 00 00
	REBASE(bnetlib, send_message_entry, 0x3CD71B36, 0x3C910000)
	REBASE(bnetlib, send_message_return, 0x3CD71B3C, 0x3C910000)
